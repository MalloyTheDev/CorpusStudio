...
3. If you added or removed a `ROOT_CONTRACTS` entry, update the contract-count assertions in
   `tests/test_platform_contracts.py` - all three: the `ROOT_CONTRACTS` count, the written-schema
   count, and the `index["contracts"]` count.
