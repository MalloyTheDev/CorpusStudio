/* GENERATED from docs/contracts/ResolvedPretrainingExecutionConfiguration.schema.json — do not edit. Run: npm run gen:contracts */
...
export type Mode = "random" | "continued";
