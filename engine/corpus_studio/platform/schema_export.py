...
ROOT_CONTRACTS: dict[str, type[ContractModel]] = {
    ...
    "ResolvedFullFinetuneExecutionConfiguration": ResolvedFullFinetuneExecutionConfiguration,
    "ResolvedPreferenceExecutionConfiguration": ResolvedPreferenceExecutionConfiguration,
    "ResolvedRewardExecutionConfiguration": ResolvedRewardExecutionConfiguration,
    "ResolvedRolloutExecutionConfiguration": ResolvedRolloutExecutionConfiguration,
    "ResolvedPretrainingExecutionConfiguration": ResolvedPretrainingExecutionConfiguration,
    "RunPlan": RunPlan,
    "RunManifest": RunManifest,
    "RunEvent": RunEvent,
    "TelemetrySample": TelemetrySample,
    "RunTelemetrySummary": RunTelemetrySummary,
